...
export default function VehicleDetailClient({ vehicle }: { vehicle: Vehicle }) {
  ...
  const phoneNumber = '+221778141252';
                          ...
                          {isFormSubmitted ? (
                            <div className="text-center py-8 px-4">
                               ...
                               <DialogHeader>
                                   ...
                                   <DialogDescription>
                                       Merci pour votre intérêt. Un conseiller EMG Universal Auto vous contactera très prochainement pour donner suite à votre demande.
                                   </DialogDescription>
                               </DialogHeader>
                               <DialogClose asChild>
